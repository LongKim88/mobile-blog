...
- **Vercel** — 배포
- **GitHub Actions cron** — 월/목 자동 초안 생성 (현재 미가동, Phase 4)
...
"이 작업을 매주 월/목 오전 8시에 실행하도록 스케줄 등록해 줘"
...
| 요일 | 카테고리 | 형식 | 분량 |
|------|----------|------|------|
| 월요일 (매주) | IT | 도구·오픈소스 소개 또는 주간 뉴스 큐레이션 | 1200~1800자 |
| 목요일 (홀수주) | IT | 주간 뉴스 큐레이션 | 800~1200자 |
| 목요일 (짝수주) | Book | 핵심 요약·서평 | 1500~2500자 |
